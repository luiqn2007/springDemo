...
public class FixedDepositDetailsAllMappingSqlQuery extends MappingSqlQuery<FixedDepositDetails> {

    public FixedDepositDetailsAllMappingSqlQuery(DataSource ds) {
        super(ds, "select * from fixed_deposit_details");
    }
