...
public class FixedDepositDetailsByBankAccountIdMappingSqlQuery extends MappingSqlQuery<FixedDepositDetails> {

    public FixedDepositDetailsByBankAccountIdMappingSqlQuery(DataSource ds) {
        super(ds, "select * from fixed_deposit_details where ACCOUNT_ID = ?");
